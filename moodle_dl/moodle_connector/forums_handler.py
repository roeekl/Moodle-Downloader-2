...
class ForumsHandler:
    ...
    def fetch_forums(self, courses: List[Course]) -> {int: {int: Dict}}:
        """
    ...
    def fetch_forums_posts(self, forums: Dict, last_timestamps_per_forum: Dict) -> {}:
        """
    ...
    def _get_files_of_discussions(self, latest_discussions: List[]) -> []:
        result = []
