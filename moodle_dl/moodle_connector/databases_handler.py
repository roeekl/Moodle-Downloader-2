...
class DatabasesHandler:
    ...
    def fetch_databases(self, courses: List[Course]) -> {int: {int: Dict}}:
        """
    ...
    def fetch_database_files(self, databases: {int: {int: Dict}}) -> {int: {int: Dict}}:
        """
    ...
    @staticmethod
    def _get_files_of_db_entries(entries: Dict) -> []:
        result = []
